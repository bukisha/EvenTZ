...
import java.util.ArrayList;
 ...
 class CategoryCardsAdapter extends RecyclerView.Adapter<CategoryCardsAdapter.CategoryNameViewHolder> {
    ...
    public CategoryNameViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CategoryNameViewHolder(cv,onClickListener);
    }
    ...
    static class CategoryNameViewHolder extends RecyclerView.ViewHolder {
         ...
         CategoryNameViewHolder(View itemView, final RecyclerViewOnItemClickListener listener) {
            ...
            categoryCard.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    listener.itemClicked(currentCategory.getName());
                }
            });
        }
    }

    private int getHomeItemLogo(String itemName) {
        switch (itemName) {
            case "Music":
                return R.drawable.ic_music_cat;
            case "Business & Professional":
                return R.drawable.ic_business_cat;
            case "Food & Drink":
                return R.drawable.ic_food_cat;
            case "Community & Culture":
                return R.drawable.ic_culture_cat;
            case "Performing & Visual Arts":
                return R.drawable.ic_art_cat;
            case "Film, Media & Entertainment":
                return R.drawable.ic_film_cat;
            case "Sports & Fitness":
                return R.drawable.ic_sport_cat;
            case "Health & Wellness":
                return R.drawable.ic_health_cat;
            case "Science & Technology":
                return R.drawable.ic_science_cat;
            case "Travel & Outdoor":
                return R.drawable.ic_travel_cat;
            case "Charity & Causes":
                return R.drawable.ic_charity_cat;
            case "Religion & Spirituality":
                return R.drawable.ic_religion_cat;
            case "Family & Education":
                return R.drawable.ic_education_cat;
            case "Seasonal & Holiday":
                return R.drawable.ic_holiday_cat;
            case "Government & Politics":
                return R.drawable.ic_politics_cat;
            case "Fashion & Beauty":
                return R.drawable.ic_fashion_cat;
            case "Home & Lifestyle":
                return R.drawable.ic_lifestyle_cat;
            case "Auto, Boat & Air":
                return R.drawable.ic_auto_cat;
            case "Hobbies & Special Interest":
                return R.drawable.ic_hobby_cat;
            case "Other":
                return R.drawable.ic_otherl_cat;
            case "School Activities":
                return R.drawable.ic_school_cat;
        }
        return 0;
    }
}
